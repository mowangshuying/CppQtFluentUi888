...
#define FluSetStyleSheet(objectName)                                           \
  setStyleSheet("../StyleSheet/" #objectName ".qss");
...
template <typename EnumType> static EnumType QStringToEnum(QString str) {
  QMetaEnum metaEnum = QMetaEnum::fromType<EnumType>();
  return (EnumType)metaEnum.keyToValue(str.toStdString().data());
}

template <typename EnumType> static QString EnumTypeToQString(EnumType type) {
  QMetaEnum metaEnum = QMetaEnum::fromType<EnumType>();
