...
//! [1]
FluFlowLayout::FluFlowLayout(QWidget *parent, int margin, int hSpacing,
                             int vSpacing)
...
//! [3]
void FluFlowLayout::addItem(QLayoutItem *item) { itemList.append(item); }
//! [3]
...
//! [5]
int FluFlowLayout::count() const { return itemList.size(); }
...
//! [7]
bool FluFlowLayout::hasHeightForWidth() const { return true; }
...
QSize FluFlowLayout::sizeHint() const { return minimumSize(); }
