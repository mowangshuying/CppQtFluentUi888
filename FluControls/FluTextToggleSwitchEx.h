...
class FluTextToggleSwitchEx : public FluWidget
{
  ...
  public:
      FluTextToggleSwitchEx(QWidget* parent = nullptr) : FluWidget(parent)
      {
          ...
          FluStyleSheetUitls::setQssByFileName(":/StyleSheet/light/FluTextToggleSwitchEx.qss", this);
    ...
    public slots:
      void onThemeChanged()
      {
          ...
          {
              FluStyleSheetUitls::setQssByFileName(":/StyleSheet/dark/FluTextToggleSwitchEx.qss", this);
          }
      }
