...
FluVNavigationViewDemo::FluVNavigationViewDemo(QWidget *parent /*= nullptr*/) : FluWidget(parent)
{
...
void FluVNavigationViewDemo::addDesignGuidaceIconText()
{
...
void FluVNavigationViewDemo::addDesignGuidaceText()
{
