...
QString FluStyleSheetUitls::getQssByFileName(const QString &jsonVars,
...
QString
FluStyleSheetUitls::getQssByFileName(const QMap<QString, QString> &kvMap,
                                     const QString &fileName) {
  QString styleSheet = getQssByFileName(fileName);
...
void FluStyleSheetUitls::replaceVar(const QString &jsonVars,
                                    QString &styleSheet) {
  QJsonParseError jsonError;
  QJsonDocument jsonDoc =
      QJsonDocument::fromJson(jsonVars.toUtf8(), &jsonError);
...
void FluStyleSheetUitls::replaceVar(const QMap<QString, QString> &kvMap,
                                    QString &styleSheet) {
