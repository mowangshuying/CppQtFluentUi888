...
class FluFlyoutPage : public FluAEmptyPage
{
  ...
  public:
      FluFlyoutPage(QWidget* parent = nullptr) : FluAEmptyPage(parent)
      {
          ...
          m_infoLabel->setText("A Flyout displays lightweight UI that is either information, or requires user interaction. Unlike a dialog, a Flyout can be light dismissed by clicking or tapping off of it.Use it to collect input from the user, show more details about an item, or ask the user to confirm an action.");
