...
public:
  ...
  void makeScrollingNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Calendar), "Scrolling",
        this);
    FluNavigationItem *item1 =
        new FluNavigationItem("AnnotatedScrollBar", item);
  ...
  void makeStatusInfoNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Calendar), "Status & info",
        this);
  ...
  void makeTextNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Font), "Text", this);
  ...
  void makeSettingsNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Settings), "Setting", this);
    m_navView->addNavigationItemButtom(item);
  }

  void makeMenuToolBarsNavItem() {
    FluNavigationItem *item =
        new FluNavigationItem(FluIconUtils::getFluentIcon(FluAwesomeType::Save),
                              "Menus & toolbars", this);
    ...
    FluNavigationItem *item5 =
        new FluNavigationItem("AppBarToggleButton", item);
  ...
  void makeMediaNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Calendar), "Media", this);
    FluNavigationItem *item1 =
        new FluNavigationItem("AnimatedVisualPlayer", item);
    FluNavigationItem *item2 =
        new FluNavigationItem("Capture Element / Camera Preview", item);
    FluNavigationItem *item3 = new FluNavigationItem("Image", item);
    FluNavigationItem *item4 =
        new FluNavigationItem("mediaPalyerElement", item);
  ...
  void makeLayoutNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::PreviewLink), "Layout",
        this);
    ...
    FluNavigationItem *item10 =
        new FluNavigationItem("VariableSizedWrapGrid", item);
  ...
  void makeDialogsFlyouts() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Comment),
        "Dialogs & flyouts", this);
  ...
  void makDateTimeNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Calendar), "Date & time",
        this);
    FluNavigationItem *item1 =
        new FluNavigationItem("CalendarDatePicker", item);
  ...
  void makeHomeNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::Home), "Home", this);
    m_navView->addNavigationItemMid(item);
  }
  ...
  void makeSamplesNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::AllApps), "All samples",
        this);
    m_navView->addNavigationItemMid(item);
  }
  ...
  void makeBasicInputNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::CheckboxComposite),
        "Basic input", this);
  ...
  void makeCollectionsNavItem() {
    FluNavigationItem *item = new FluNavigationItem(
        FluIconUtils::getFluentIcon(FluAwesomeType::TiltDown), "Connections",
        this);
