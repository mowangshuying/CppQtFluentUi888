...
class FluHomePageTitle : public QWidget
{
  ...
  public:
    FluHomePageTitle(QWidget* parent = nullptr) : QWidget(parent)
    {
        ...
        auto winuiGithubCard = new FluVCard(QPixmap("../res/HomeHeaderTiles/Header-WindowsDesign.png"), "CppFluentUi Github", "The latest Windows native controls and styles for your applications", this);
