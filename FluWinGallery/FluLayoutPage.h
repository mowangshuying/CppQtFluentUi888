...
class FluLayoutPage : public FluATitlePage
{
  ...
  public:
      FluLayoutPage(QWidget* parent = nullptr) : FluATitlePage(parent)
      {
          ...
          connect(borderCard, &FluHCard::clicked, [=](QString key){
          ...
          connect(canvasCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(expanderCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(gridCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(itemsRepeaterCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(radioButtonsCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(relativePanelCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(splitViewCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(stackPanelCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });

          auto variableSizedWrapGridCard = new FluHCard(QPixmap("../res/ControlImages/VariableSizedWrapGrid.png"), "VariableSizedWrapGrid", "A layout panel that supports arranging child elements in rows and columns. Each child element can span multiple rows and columns.");
          ...
          connect(variableSizedWrapGridCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
          ...
          connect(viewboxCard, &FluHCard::clicked, [=](QString key) { 
              emit clickedHCard(key);
          });
      }
signals:
