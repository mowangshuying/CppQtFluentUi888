...
class FluScrollingPage : public FluATitlePage
{
    Q_OBJECT
  public:
      FluScrollingPage(QWidget* parent = nullptr) : FluATitlePage(parent)
      {
          m_vMainLayout->setAlignment(Qt::AlignTop);
          m_titleLabel->setText("Scrolling");

          auto annotatedScrollBarCard = new FluHCard(QPixmap("../res/ControlImages/AnnotatedScrollBar.png"), "AnnotatedScrollBar",
          ...
          connect(annotatedScrollBarCard, &FluHCard::clicked, [=](QString key) { emit clickedHCard(key); });
              ...
              auto pipsPagerCard =
                  new FluHCard(QPixmap("../res/ControlImages/PipsPager.png"), "PipsPager", 
              ...
              auto scrollViewCard =
                  new FluHCard(QPixmap("../res/ControlImages/ScrollView.png"), "ScrollView", "A container control that lets the user pan and zoom its content.");
              ...
              auto scrollViewerCard =
                  new FluHCard(QPixmap("../res/ControlImages/ScrollViewer.png"), "ScrollViewer", 
              ...
              auto semanticZoomCard =
                  new FluHCard(QPixmap("../res/ControlImages/SemanticZoom.png"), "SemanticZoom", "Lets the user zoom between two different views of a collection, making it easier to navigate through large collections of items..");
