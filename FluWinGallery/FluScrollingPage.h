  ...
  public:
    FluScrollingPage(QWidget* parent = nullptr) : FluATitlePage(parent)
    {
        ...
        auto annotatedScrollBarCard =
            new FluHCard(QPixmap("../res/ControlImages/AnnotatedScrollBar.png"), "AnnotatedScrollBar", "A control that extends a regular vertical scrollbar's functionality for an easy navigation through large collections.");
